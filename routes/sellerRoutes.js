...
const { sellerFetchProduct, selleraddProduct, sellerupdateProduct, sellerdeleteProduct } = require("../controller/sellerController");

const router = express.Router();

router.route("/seller/product/fetch").get(protect,sellerFetchProduct );
router.route("/seller/product/add").post(protect,selleraddProduct );
